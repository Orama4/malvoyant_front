...
object RetrofitClient {
    const val IP_ADR = "172.20.10.3"

    private const val AUTH_BASE_URL = "http://$IP_ADR:3001"  // Localhost for emulator
    private const val CONTACTS_BASE_URL = "http://$IP_ADR:3002"
    // Auth service client
